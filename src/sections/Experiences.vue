<template>
  <PageSectionWrapper :id="experiencesData.id" :title="experiencesData.title" :subtitle="experiencesData.subtitle">
    <div class="row h-100">
      <template v-for="project in experiencesData.projects">
        <div class="col-6 col-md-4 mb-4">
          ...
          <div class="portfolio-item box-shadow-with-border h-100">
            ...
            <a class="portfolio-link" @click="_onProjectSelected(project)">
              ...
              <img class="experience-cover-img img-fluid" :src="project.srcImage" :alt="project.title" />
            </a>

            <!-- Info -->
            <div class="portfolio-caption">
              <h5 class="mb-1">{{ project.title }}</h5>
              <p class="portfolio-item-category text-muted">{{ project.location }}<br/>{{ project.time }}</p>
            </div>
          </div>
        </div>
      </template>
...
const experiencesData = agencyData.experiences
